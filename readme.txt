...
1. Upload the `polygon-recent-comments-with-avatar` folder to the `/wp-content/plugins/` directory
1. Activate the Polygon Recent Comments With Avatar plugin through the 'Plugins' menu in WordPress
